...
local M = {
	setting = {
        name = 'tm-ADDONS',
        url_script = 'https://raw.githubusercontent.com/DIMaslov1904/ToolsMate/main/ToolsMate/ADDONS.lua',
        urp_version = 'https://raw.githubusercontent.com/DIMaslov1904/ToolsMate/main/version.json',
        version = "1.0.0",
        path_script = getWorkingDirectory() .. '\\ToolsMate\\ADDONS.lua',
        tag = 'ToolsMate'
    }
}
setmetatable(M, {
...
M.CloseButton = function(str_id, value, size, rounding)
	...
	if imgui.Button(str_id, imgui.ImVec2(size, size)) then
		value[0] = false
	end
	DL:AddLine(
